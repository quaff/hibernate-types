...
import com.vladmihalcea.hibernate.type.util.PropertyType;
...
public class PostgreSQLJsonBinaryTypeTestProgrammaticPropertyTest extends AbstractPostgreSQLIntegrationTest {
    ...
    protected void additionalProperties(Properties properties) {
        ...
        JsonBinaryType jsonBinaryType = new JsonBinaryType(customObjectMapperSupplier.get());

        PropertyType<Location> locationParameterType = new PropertyType<Location>() {
            @Override
            public Class<Location> getReturnedClass() {
                return Location.class;
            }
        };

        jsonBinaryType.setParameterValues( locationParameterType.toProperties() );
